...
namespace NZWalks.API.Migrations
{
    ...
    [Migration("20230216193826_adding user")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NZWalks.API.Model.Domain.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalks.API.Model.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalks.API.Model.Domain.User_Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalks.API.Model.Domain.User_Role", b =>
                {
                    b.HasOne("NZWalks.API.Model.Domain.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NZWalks.API.Model.Domain.User", "User")
                        .WithMany("UserRoles")
